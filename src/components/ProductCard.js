...
export const ProductCard = ({ title, country, price, description, img,
    ...
    const cardClasses = `card shadow p-3 product-card w-100 h-100 ${full && 'flex-row mx-auto full-product-card fs-4'} ${!available && 'bg-dark bg-opacity-25'}`; // 
    ...
    const imgStyle = {
        ...
        objectFit: full ? 'scale-down' : 'contain',
    }
