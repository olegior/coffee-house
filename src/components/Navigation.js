...
export const Navigation = ({ color, center }) => {
    return (
        <nav className="navbar navbar-expand container" data-bs-theme={color && "dark"}>
                    ...
                    <svg width="30" height="30" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <defs>
                            <clipPath id="clip0_4_86">
                                <rect width="29.302" height="29.302" fill={color ? "white" : "black"} />
                            </clipPath>
                        </defs>
                    </svg>

                    {/* <img src="assets/logo.png" alt="Logo" className="d-inline-block align-text-bottom" style={white && { filter: "invert(1)" }} /> */}
                    Coffee house</Link>
                <Link className="nav-link" 
                style={{ paddingTop: '10px' }} 
                to="/our-coffee">Our coffee</Link>
                <Link className="nav-link" 
                style={{ paddingTop: '10px' }} 
                to="/for-your-pleasure">For your pleasure</Link>
            </div>
        </nav>
    )
}
